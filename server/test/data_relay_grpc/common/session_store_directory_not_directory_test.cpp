...
class session_store_directory_not_directory_test : public data_relay_grpc::grpc::grpc_server_test_base {
protected:
    const std::uint64_t tag_for_test = 2468;

    std::unique_ptr<directory_helper> helper_{std::make_unique<directory_helper>("session_store_directory_not_directory_test")};
...
TEST_F(session_store_directory_not_directory_test, not_directory) {
